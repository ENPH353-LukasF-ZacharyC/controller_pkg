...
class licensePlateHandler():
    ...
    def get_lp_letters(self, img):
        ...
        lp = self.get_license_plates(img)
        filtered =[]
        for img in lp:
    ...
    def get_car_back(self, img):
        ...
        self.carBacks = carBacks
        return carBacks

    def corner_sorter(self, lop):
        """
    ...
    def reportLicensePlate(self, img):
        status, letters = self.get_lp_letters(img)
